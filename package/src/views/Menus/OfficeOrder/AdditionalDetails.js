...
// // //         p_role: "",
// // //         p_requested_user: isReject ? returnToUser : "",
...
// // //           }}
// // //         >
// // //           <h2 style={headingStyle}>Additional Details</h2>
// // //         </div>
...
// //   FavoriteButton,
// //   CancelButton,
// // } from "src/components/ui/Button.js";
...
// //           : "",
// //         p_footer_html: sanitizeField(formData.footer),
// //         p_assign_to: Cookies.get("EmpId"),
// //         p_assigned_role: Cookies.get("selectedRole"),
// //         p_task_status_id: 22,
// //         p_activity_seq_no: actualTaskData?.ActivitySeqNo || 0,
// //         p_is_task_return: false,
...
//   /**
//    * Handles submission of the form via API.
//    * Inserts the payload similar to save, but with "Submit" type.
//    */
//   const handleSubmit = async () => {
//     try {
//       setLoading(true);
...
//         session_id: sessionId,
//         typeofsubmit: "Submit",
//         p_cover_page_no: record?.coverpageno || sanitizeField(
//           actualTaskData?.CoverPageNo ||
//             actualTaskData?.coverpageno 
//         ),
//         p_employee_id: sanitizeField(formData.employeeid),
...
//         p_header_html: sanitizeField(formData.header) || "",
//         p_order_no: sanitizeField(bodyData.referencenumber) || "",
//         p_order_date: formatDateForAPI(bodyData.Date, "00:00:00")?.split("T")[0] || new Date().toISOString().split("T")[0],
//         p_to_column: generateToColumnHtml(),
//         p_subject: sanitizeField(bodyData.subject) || "",
//         p_reference: sanitizeField(bodyData.refsubject),
//         p_body_html: sanitizeField(bodyData.body),
...
//         p_assign_to: "",
//         p_assigned_role: "",
//         p_task_status_id: 4, // Assuming approve/submit status
//          p_task_id: actualTaskData?.TaskId,

//         p_activity_seq_no: actualTaskData?.ActivitySeqNo || 1,
//         p_is_task_return: false,
//         p_is_task_approved: true,
//         p_initiated_by: sanitizeField(actualTaskData?.InitiatedBy || empId) || "admin",
//         p_initiated_on: actualTaskData?.InitiatedOn || new Date().toISOString(),
//         p_updated_by: sanitizeField(empId) || "admin",
//         p_updated_on: new Date().toISOString(),
//         p_process_id: Number(
...
//       if (!response.ok) throw new Error("Failed to submit Office Order");
...
const AdditionalDetails = ({ taskData, onClose, record, showSnackbar }) => {
  ...
  const handleChange = (e) => {
    ...
    // Always allow updates to remarks field
    if (name === "remarks") {
      setFormData((prev) => ({ ...prev, [name]: value }));
      return;
    }
      ...
      <div style={cardStyle}>
        ...
        >
          ...
          >
            ...
            <FormSection style={readOnlySectionStyle}>
              <div style={sectionHeaderStyle}>
                <h3 style={sectionHeadingStyle}>Remarks</h3>
              </div>
              <div style={{ marginBottom: "12px" }}>
                <TextField
                  label="Remarks"
