...
// // //         p_role: userRole,
// // //         p_requested_user: formData.employeeid,
...
// //   // Define consistent header color to match table headers
...
// //             {/* --- Employee Info Section (COMPACT) --- */}
// //             <FormSection headerColor={headerColor} style={readOnlySectionStyle}>
// //               <div style={sectionHeaderStyle}>
// //                 <h3 style={sectionHeadingStyle}>
// //                   Employee Information
// //                 </h3>
...
// //             {/* --- Office Order Details Section (COMPACT) --- */}
// //             <FormSection headerColor={headerColor} style={officeOrderSectionStyle}>
// //               <div
// //                 style={{
// //                   ...officeOrderHeaderStyle,
// //                   backgroundColor: isOfficeOrderEditable
...
// //                     ? "1px solid #CFD8DC"
// //                     : "none",
// //                   color: isOfficeOrderEditable ? "#000000" : "#FFFFFF",
// //                 }}
// //                 onClick={() => setIsOfficeOrderExpanded(!isOfficeOrderExpanded)}
// //               >
// //                 <div
...
// //                     style={{
// //                       ...sectionHeadingStyle,
// //                       color: isOfficeOrderEditable ? "#9D5A00" : "#FFFFFF",
// //                       marginRight: "15px",
// //                     }}
// //                   >
// //                     Office Order Content & Details
...
// //                       fontSize: "12px",
// //                       fontWeight: "500",
// //                       color: isOfficeOrderEditable ? "#A16207" : "#FFFFFF",
// //                       backgroundColor: isOfficeOrderEditable
// //                         ? "#FEF3C7"
...
// //                         ? "#10B981"
// //                         : "rgba(255, 255, 255, 0.2)",
// //                       color: isOfficeOrderEditable ? "#FFFFFF" : "#FFFFFF",
// //                       padding: "4px 12px",
// //                       fontSize: "11px",
// //                       borderRadius: "4px",
// //                     }}
// //                   >
// //                     {isOfficeOrderEditable ? "Exit Edit" : "Edit Content"}
// //                   </button>
// //                   <svg
// //                     width="20"
// //                     height="20"
// //                     viewBox="0 0 24 24"
// //                     fill="none"
// //                     stroke={isOfficeOrderEditable ? "#000000" : "#FFFFFF"}
// //                     strokeWidth="2"
// //                     style={{
// //                       transform: isOfficeOrderExpanded
// //                         ? "rotate(180deg)"
...
//   // Define consistent header color only for CommentsSection
...
//         p_task_id: actualTaskData?.TaskId || null,
//         p_role: "",
//         p_requested_user: Cookies.get("EmpId"),
//         p_return_to_role: isReject ? (returnUserOptions.find(opt => opt.value === returnToUser)?.label || "") : "",
//         p_return_to_user: isReject ? returnToUser : "",
//         p_send_back_to_me: sendBackToMe,
//         p_send_back_to_user: sendBackToMe ? Cookies.get("EmpId") : "",
  ...
  const handleSave = async () => {
    try {
      ...
      const reqpayload = {
        ...
        p_reject_flag: 0,
        p_user_role: userRole,
        // Added missing fields for consistency with submit payload to ensure updates (including body_html) are properly linked and persisted
        p_original_order_no: "",
        p_order_type: actualTaskData?.ProcessKeyword || "",
        p_task_id: actualTaskData?.TaskId || null,
        p_role: "",
